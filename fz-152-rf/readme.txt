...
= 0.2.6 =
* Исправлено: устранена рекурсивная петля внутреннего сканера, которая на отдельных конфигурациях могла запускать множество loopback-запросов к сайту, перегружать WP-Cron, CPU и память.
